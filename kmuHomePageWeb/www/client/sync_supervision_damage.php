<?php 
   ...
   //------------------------------------------------------------------------------------------
   $query  = "SELECT * FROM tbl_supervision_damage ";
   ...
   if( $result && $count > 0 )
   {            
       $query  = "UPDATE tbl_supervision_damage SET ";
       $query .= "worker = '{$worker}' ";
       $query .= ", agency = '{$agency}' ";
       ...
       if($result)
       {
           $return = array("result"=>"UPDATE", "table"=>"SUPERVISION_DAMAGE", "id_project"=>$id_project, "id_serial"=>$id_serial,
       ...
       {
           $return = array("result"=>"FAIL", "table"=>"SUPERVISION_DAMAGE", "id_project"=>$id_project, "id_serial"=>$id_serial,
                   "sync_datetime"=>"");            
           echo a2json($return);
       }
   }
   ...
   {
       $query  = "INSERT INTO tbl_supervision_damage ";
       ...
       {				
           if($count==1)
           {
               $return = array("result"=>"INSERT", "table"=>"SUPERVISION_DAMAGE", "id_project"=>$id_project, "id_serial"=>$id_serial,
                       "sync_datetime"=>date("Y-m-d H:i:s"));            
               echo a2json($return);
           }					
