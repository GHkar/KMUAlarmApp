<?php /* Template_ 2.2.8 2018/11/02 15:26:30 /namgang5995/www/admin/design_smoke.html 000004081 */ 
$TPL_design_smoke_1=empty($TPL_VAR["design_smoke"])||!is_array($TPL_VAR["design_smoke"])?0:count($TPL_VAR["design_smoke"]);?>
<html>
<head>
...
<script>
	var excelTable = "design_smoke";
	var tableName = "훈증더미 설계";
</script>
<style>
		...
		<div id="title-area" class="reset margin-all-auto">
			...
			<div id="excel" class="right">
				<form id="excel-form" class="reset po-a" method="POST" ENCTYPE="multipart/form-data">
					<a class="none" href="/admin/form/design_smoke.xlsx" target="_blank">양식 다운로드</a>
...
<?php if($TPL_design_smoke_1){foreach($TPL_VAR["design_smoke"] as $TPL_V1){?>
			<tr>
