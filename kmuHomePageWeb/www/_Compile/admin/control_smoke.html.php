<?php /* Template_ 2.2.8 2018/11/02 15:26:30 /namgang5995/www/admin/control_smoke.html 000004607 */ 
$TPL_control_smoke_1=empty($TPL_VAR["control_smoke"])||!is_array($TPL_VAR["control_smoke"])?0:count($TPL_VAR["control_smoke"]);?>
<html>
<head>
...
<script>
	var excelTable = "control_smoke";
	var tableName = "훈증더미 제거";
</script>
<style>
		...
		<div id="title-area" class="reset margin-all-auto">
			...
			<div id="excel" class="right">
				<form id="excel-form" class="reset po-a" method="POST" ENCTYPE="multipart/form-data">
					<a class="none" href="/admin/form/control_smoke.xlsx" target="_blank">양식 다운로드</a>
...
<?php if($TPL_control_smoke_1){foreach($TPL_VAR["control_smoke"] as $TPL_V1){?>
			<tr>
				...
				<td><?php echo $TPL_V1["height"]?>/<?php echo $TPL_V1["length"]?></td>
