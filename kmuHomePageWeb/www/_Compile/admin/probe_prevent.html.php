<?php /* Template_ 2.2.8 2018/11/02 15:26:30 /namgang5995/www/admin/probe_prevent.html 000003841 */ 
$TPL_probe_prevent_1=empty($TPL_VAR["probe_prevent"])||!is_array($TPL_VAR["probe_prevent"])?0:count($TPL_VAR["probe_prevent"]);?>
<html>
<head>
...
<script>
	var excelTable = "probe_prevent";
	var tableName = "예방나무주사 조사";
</script>
<style>
...
<?php if($TPL_probe_prevent_1){foreach($TPL_VAR["probe_prevent"] as $TPL_V1){?>
			<tr>
