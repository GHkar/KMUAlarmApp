<?php /* Template_ 2.2.8 2018/11/02 15:26:30 /namgang5995/www/admin/design_damage.html 000004121 */ 
$TPL_design_damage_1=empty($TPL_VAR["design_damage"])||!is_array($TPL_VAR["design_damage"])?0:count($TPL_VAR["design_damage"]);?>
<html>
<head>
...
<script>
	var excelTable = "design_damage";
	var tableName = "피해목 설계";
</script>
<style>
	...
	<div id="contents">
		<div id="title-area" class="reset margin-all-auto">
			...
			<div id="excel" class="right">
				<form id="excel-form" class="reset po-a" method="POST" ENCTYPE="multipart/form-data">
					<a class="none" href="/admin/form/design_damage.xlsx" target="_blank">양식 다운로드</a>
		...
		<table id="table" class="table reset margin-all-auto">
			<tr id="table-header">
				...
				<td width="">피해종류</td>
				<td width="">방제방법</td>
				<td width="100">경급_1</td>
				<td width="100">경급_2</td>
				<td width="100">경급_3</td>
...
<?php if($TPL_design_damage_1){foreach($TPL_VAR["design_damage"] as $TPL_V1){?>
			<tr>
