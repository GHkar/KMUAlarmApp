<?php /* Template_ 2.2.8 2018/11/02 15:26:30 /namgang5995/www/admin/control_prevent.html 000004491 */ 
$TPL_control_prevent_1=empty($TPL_VAR["control_prevent"])||!is_array($TPL_VAR["control_prevent"])?0:count($TPL_VAR["control_prevent"]);?>
<html>
<head>
...
<script>
	var excelTable = "control_prevent";
	var tableName = "예방나무주사 실행";
</script>
<style>
		...
		<div id="title-area" class="reset margin-all-auto">
			...
			<div id="excel" class="right">
				<form id="excel-form" class="reset po-a" method="POST" ENCTYPE="multipart/form-data">
					<a class="none" href="/admin/form/control_prevent.xlsx" target="_blank">양식 다운로드</a>
...
<?php if($TPL_control_prevent_1){foreach($TPL_VAR["control_prevent"] as $TPL_V1){?>
			<tr>
				...
				<td><?php echo $TPL_V1["perforation_num_design"]?></td>
				...
				<td><?php echo $TPL_V1["perforation_num_control"]?></td>
