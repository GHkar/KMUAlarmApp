        ...
        , View.OnClickListener
{
    ...
    protected void initControl()
    {
        ...
        findViewById(R.id.btnSWBusiness).setOnClickListener(this);
...
//        findViewById(R.id.btnSchool).setOnClickListener(listener -> onClickBtnSchool());
    ...
    public void onClick(View view)
    {
        switch(view.getId()) // view가 부모클래스 -> button -> getId -> 버튼 Id를 가지고 올 수 있어.
        {
            case R.id.btnHome:
            {
                Intent intent = new Intent(AvtKmuPage.this, AvtMenu.class);
            ...
            case R.id.btnSWBusiness:
            {
                Intent intent = new Intent(AvtKmuPage.this, AvtSWBusiness.class);
                startActivity(intent);
                finish();
    ...
    public boolean onCreateOptionsMenu(Menu menu)
    {
        ...
        getMenuInflater().inflate(R.menu.avt_kmu_page, menu);
        return true;
    }
    //--------------------------------------------------------------------------------------------//
    //
